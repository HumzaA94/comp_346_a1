...
public class Network extends Thread {
    ...
    private static final Transactions Transactions = null;
...
//    	System.out.println("\n DEBUG : Network.run() - starting network thread");
    	...
    	while (true)
    	{
    		...
    		if (getClientConnectionStatus().contentEquals("disconnected")&getServerConnectionStatus().contentEquals("disconnected")) {
    			System.out.println("\n Terminating network thread- Client disconnected Server disconnected");
    			System.exit(0);
    		}
    		if (getInBufferStatus().equals("full")|getOutBufferStatus().equals("full")|getOutBufferStatus().equals("empty")) 
    			Thread.yield();
